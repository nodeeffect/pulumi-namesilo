...
namespace Pulumi.Namesilo
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Namesilo.version.txt");
    ...
    internal sealed class NamesiloResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public NamesiloResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
